...
const ProfilePage = () => {
  ...
  const fetchUser = async () => {
    ...
    {user.profilePic? <img src={user.profilePic} alt={user.username} style={{width: "4rem", height: "auto", borderRadius: "50%", fitContent: "cover", marginRight: " 0.5rem", backgroundColor: "transparent",}}/> : <FontAwesomeIcon icon={faUser} style={{background: 'none', color: 'purple', float: 'left'}}></FontAwesomeIcon>}
